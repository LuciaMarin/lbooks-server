    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (("".equalsIgnoreCase(ob) && "".equalsIgnoreCase(op)) || (ob == null && op == null)) {
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<html><head><title>L-Books</title></head><body>");
                out.println("<h1>Bienvenidos al servidor web L-Books</h1>");
            ...
            try (PrintWriter out = response.getWriter()) {
                try {
                    ...
                    if (ConfigurationSettings.environment == EnvironmentConstans.Debug) {
                        ...
                        ResponseBean oResponseBean = new ResponseBean(500, "L-Books ERROR: Please contact your administrator");
                        Gson oGson = new Gson();
